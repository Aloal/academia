...
public class Ejercicio6C extends JFrame {
	...
	public Ejercicio6C() throws FontFormatException, IOException {
		//InputStream is= Ejercicio6.class.getResourceAsStream("/Espania Normal.ttf");
		// font = Font.createFont(Font.PLAIN, is).deriveFont(50f); 
...
//		menuArchivoAbrir.addActionListener((e) -> abrir());		
		...
		//texto.setFont(font);
		texto.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createCompoundBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10), BorderFactory.createLineBorder(Color.BLUE)), BorderFactory.createEmptyBorder(20, 20, 20, 20)));
